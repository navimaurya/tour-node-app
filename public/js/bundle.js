...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGF3b2NhNzc4OCIsImEiOiJja2JseWpqa2ExY202MnRteXZhZ3FxYW50In0.JYnWXkXS8LqK0zgmg1UqbQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/pawoca7788/ckblyx4z00leq1in0ddvoe5o6',
    scrollZoom: false
  });
...
exports.stopLoader = exports.runLoader = void 0;

var runLoader = function runLoader() {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              //   '<h2 class="danger mx-auto" style="color : #55c57a"> Logged in successfully..... </h2>\n <h2 class="danger ma-bt-lg mx-auto" style = "color : #55c57a" > Loading..... </h2 >';
              document.querySelector('.load').classList.remove('loader-main');
              (0, _alerts.showAlert)('success', 'Successfully Updated!'); //   window.setTimeout(() => {
              //     location.assign('/me');
              //   }, 3000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./loader":"loader.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51GwkAxJVkLdgMbrcGZtJIxg9m7gs8xEW4oF5N61MfLhZMqZIZnkgGOFoXMB23cvhuKkKVCr186JK2UKKCUzB2baN00M35SCLel');
            _context.prev = 1;
            _context.next = 4;
...
var bookBtn = document.getElementById('book-tour'); //mapbox
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 8;
              return (0, _updateSettings.updateSetting)('PATCH', '/api/v1/users/updateMe', form);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 7;
              return (0, _updateSettings.updateSetting)('PATCH', '/api/v1/users/updatepassword', {
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              (0, _loader.runLoader)();
              tourid = e.target.dataset.tourid; // console.log(tourid);
